...
import com.chortitzer.lab.semillas.domain.LabMuestrasSemillas;
...
public class FormMuestras extends JPanel {
    ...
    private void initComponents() {
        ...
        categoriasListCellRenderer1 = new com.chortitzer.lab.semillas.utils.CategoriasListCellRenderer();
        especiesListCellRenderer1 = new com.chortitzer.lab.semillas.utils.EspeciesListCellRenderer();
        categoriasTableCellRenderer1 = new com.chortitzer.lab.semillas.utils.CategoriasTableCellRenderer();
        especiesTableCellRenderer1 = new com.chortitzer.lab.semillas.utils.EspeciesTableCellRenderer();
        ...
        radioButtonConverter1 = new com.chortitzer.lab.semillas.utils.RadioButtonConverter();
        muestraLoteTableCellRenderer1 = new com.chortitzer.lab.semillas.utils.MuestraLoteTableCellRenderer();
        ...
        muestreadoresTableCellRenderer1 = new com.chortitzer.lab.semillas.utils.MuestreadoresTableCellRenderer();
        muestreadoresListCellRenderer1 = new com.chortitzer.lab.semillas.utils.MuestreadoresListCellRenderer();
        clientesTableCellRenderer1 = new com.chortitzer.lab.semillas.utils.ClientesTableCellRenderer();
        clientesListCellRenderer1 = new com.chortitzer.lab.semillas.utils.ClientesListCellRenderer();
        categoriasConverter1 = new com.chortitzer.lab.semillas.utils.CategoriasConverter();
        clientesConverter1 = new com.chortitzer.lab.semillas.utils.ClientesConverter();
        especiesConverter1 = new com.chortitzer.lab.semillas.utils.EspeciesConverter();
        muestreadoresConverter1 = new com.chortitzer.lab.semillas.utils.MuestreadoresConverter();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.chortitzer.lab.semillas.domain.LabMuestrasSemillas> toRemove = new ArrayList<com.chortitzer.lab.semillas.domain.LabMuestrasSemillas>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.chortitzer.lab.semillas.domain.LabMuestrasSemillas l = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(l);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.chortitzer.lab.semillas.domain.LabMuestrasSemillas> merged = new ArrayList<com.chortitzer.lab.semillas.domain.LabMuestrasSemillas>(list.size());
            for (com.chortitzer.lab.semillas.domain.LabMuestrasSemillas l : list) {
    ...
    private com.chortitzer.lab.semillas.utils.CategoriasConverter categoriasConverter1;
    private com.chortitzer.lab.semillas.utils.CategoriasListCellRenderer categoriasListCellRenderer1;
    private com.chortitzer.lab.semillas.utils.CategoriasTableCellRenderer categoriasTableCellRenderer1;
    ...
    private com.chortitzer.lab.semillas.utils.ClientesConverter clientesConverter1;
    private com.chortitzer.lab.semillas.utils.ClientesListCellRenderer clientesListCellRenderer1;
    private com.chortitzer.lab.semillas.utils.ClientesTableCellRenderer clientesTableCellRenderer1;
    private javax.swing.JButton deleteButton;
    private javax.persistence.EntityManager em;
    private javax.persistence.EntityManager entityManager;
    private javax.persistence.EntityManager entityManagerMuestreadores;
    private com.chortitzer.lab.semillas.utils.EspeciesConverter especiesConverter1;
    private com.chortitzer.lab.semillas.utils.EspeciesListCellRenderer especiesListCellRenderer1;
    private com.chortitzer.lab.semillas.utils.EspeciesTableCellRenderer especiesTableCellRenderer1;
    ...
    private java.util.List<com.chortitzer.lab.semillas.domain.LabMuestrasSemillas> list;
    private java.util.List listCategorias;
    private java.util.List listClientes;
    private java.util.List listEspecies;
    private java.util.List<com.chortitzer.lab.semillas.domain.LabMuestrasSemillas> listMuestreadores;
    ...
    private com.chortitzer.lab.semillas.utils.MuestraLoteTableCellRenderer muestraLoteTableCellRenderer1;
    private javax.swing.JLabel muestraOLoteLabel;
    private com.chortitzer.lab.semillas.utils.MuestreadoresConverter muestreadoresConverter1;
    private com.chortitzer.lab.semillas.utils.MuestreadoresListCellRenderer muestreadoresListCellRenderer1;
    private com.chortitzer.lab.semillas.utils.MuestreadoresTableCellRenderer muestreadoresTableCellRenderer1;
    ...
    private com.chortitzer.lab.semillas.utils.RadioButtonConverter radioButtonConverter1;
