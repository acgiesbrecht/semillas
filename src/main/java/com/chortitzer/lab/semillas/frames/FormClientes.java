...
public class FormClientes extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.chortitzer.lab.semillas.domain.LabClientes> toRemove = new ArrayList<com.chortitzer.lab.semillas.domain.LabClientes>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.chortitzer.lab.semillas.domain.LabClientes l = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(l);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        com.chortitzer.lab.semillas.domain.LabClientes l = new com.chortitzer.lab.semillas.domain.LabClientes();
...
//        l.setId((Integer) entityManager1.createQuery("select max(t.id)+1 from LabClientes t").getSingleResult());
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.chortitzer.lab.semillas.domain.LabClientes> merged = new ArrayList<com.chortitzer.lab.semillas.domain.LabClientes>(list.size());
            for (com.chortitzer.lab.semillas.domain.LabClientes l : list) {
    ...
    private java.util.List<com.chortitzer.lab.semillas.domain.LabClientes> list;
