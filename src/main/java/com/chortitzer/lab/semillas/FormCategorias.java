...
public class FormCategorias extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.chortitzer.lab.semillas.LabSemillasCategorias> toRemove = new ArrayList<com.chortitzer.lab.semillas.LabSemillasCategorias>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.chortitzer.lab.semillas.LabSemillasCategorias l = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(l);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        com.chortitzer.lab.semillas.LabSemillasCategorias l = new com.chortitzer.lab.semillas.LabSemillasCategorias();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.chortitzer.lab.semillas.LabSemillasCategorias> merged = new ArrayList<com.chortitzer.lab.semillas.LabSemillasCategorias>(list.size());
            for (com.chortitzer.lab.semillas.LabSemillasCategorias l : list) {
    ...
    private java.util.List<com.chortitzer.lab.semillas.LabSemillasCategorias> list;
